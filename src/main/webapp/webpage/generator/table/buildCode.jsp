  ...
  <div class="portlet-body form">
  	<form id="buildCodeForm" class="form-horizontal form-bordered" action="/generator/buildCode" method="post">
        ...
        <div class="col-md-4">
        	<div class="input-icon right" >
	          ...
	          <input type="text" class="form-control" name="projectPath" value="D:\mylog\shop" required/>
	        </div>
        </div>
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <div class="col-md-4">
        	<div class="input-icon right">
	        	<i class="fa"></i>
        		<input type="text" class="form-control" name="sourceBasePackage" value="com.yl" placeholder="com.yl" required/>
        	</div>
        </div>
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <div class="col-md-4">
        	<div class="input-icon right">
	        	<i class="fa"></i>
	          <input type="text" class="form-control" name="entityPackage" value="shop" placeholder="shop" required maxlength="200"/>
	        </div>
        </div>
      </div>
      <div class="form-group">
